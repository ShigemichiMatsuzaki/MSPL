...
#    --os-model1 espdnetue \
#    --outsource1 camvid \
#    --os-weights1 /tmp/runs/model_espdnetue_camvid/s_2.0_sch_hybrid_loss_ce_res_480_sc_1.0_1.0_rgb/20200715-164256/espdnetue_2.0_480_best.pth \
#    --os-model2 espdnetue \
#    --outsource2 cityscapes \
#    --os-weights2 /tmp/runs/model_espdnetue_city/s_2.0_sch_hybrid_loss_ce_res_512_sc_0.25_0.5_rgb/20200717-161219/espdnetue_2.0_512_best.pth
